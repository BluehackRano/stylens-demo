...
-(void)setProductImageWithUIImage:(UIImage*)anImage {
    [[NSOperationQueue mainQueue]addOperationWithBlock:^{
        ...
        //                self.productImageView.frame = CGRectMake(0, 0, self.productImageBgView.frame.size.width, self.productImageBgView.frame.size.height);
        
        //                self.cropView = [[PECropView alloc] initWithFrame:self.productImageView.bounds];
        //                [self.productImageView addSubview:self.cropView];
...
//-(void)setProductImage:(UIImage *)aProductImage {
//    self.productImageView.image = aProductImage;
//}
