...
-(void)setProductInfo:(ProductInfo *)aProductInfo {
    ...
    [apiInstance getObjectsByProductIdWithProductId:_productInfo._id
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    EditorCell *cell = (EditorCell *)[collectionView dequeueReusableCellWithReuseIdentifier:EDITOR_CELL_IDENTIFIER
