...
-(id)init {
    ...
    if(self) {
        ...
        self.editorResultInfos = [[NSMutableArray alloc] init];
...
//            aProductInfo.title = [NSString stringWithFormat:@"ITEM_%d", i];
//            aProductInfo.imageName = [NSString stringWithFormat:@"cat%d.jpg", i%5 == 0 ? 5 : i%5];
//            aProductInfo.price = [NSNumber numberWithInt:(10000+i)];
//            
//            UIImage *anImage = [UIImage imageNamed:aProductInfo.imageName];
